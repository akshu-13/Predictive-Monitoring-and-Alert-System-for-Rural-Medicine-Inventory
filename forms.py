...
class DrugPredictionForm(forms.Form):
    drug = forms.ModelChoiceField(queryset=Stock.objects.all(), label="Select Drug")
    days = forms.IntegerField(initial=30, min_value=7, max_value=90, label="Days to Predict")
